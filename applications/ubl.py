...
def run_fahp_for_ubl():
    # Step 1: Load dataset
    df = pd.read_excel('E:/Qurratulain/FHP-performance-testing-mobile-apps/dataset/UBL_combined.xlsx')

    # Step 2: Define the criteria and pairwise comparisons
    criteria = ['Elapsed Time', 'Throughput', 'Load/Network', 'Latency']

    # Pairwise comparisons based on linguistic judgments for UBL
    pairwise_comparisons = {
        'Elapsed Time': [(7, 9, 9), (7, 9, 9), (5, 7, 9)],  # Comparisons with other criteria
        'Throughput': [(3, 5, 7), (1, 3, 5)],               # Comparisons with Load/Network, Latency
    ...
    save_results_to_csv_and_visualize(priority_weights, 'results/ubl_fahp_results.csv','UBL')
