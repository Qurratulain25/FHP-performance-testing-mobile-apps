...
def run_fahp_for_easy_paisa():
    # Step 1: Load dataset
    df = pd.read_excel('E:/Qurratulain/FHP-performance-testing-mobile-apps/dataset/EASY_PAISA_combined.xlsx')
    ...
    save_results_to_csv_and_visualize(priority_weights, 'results/easy_paisa_fahp_results.csv','Easy paisa')
